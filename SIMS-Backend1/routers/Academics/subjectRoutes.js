...
router.put('/:id', protect, checkRole('admin', 'superadmin','teacher'), subjectController.updateSubject);
router.delete('/:id', protect, checkRole('admin', 'superadmin','teacher'), subjectController.deleteSubject);
