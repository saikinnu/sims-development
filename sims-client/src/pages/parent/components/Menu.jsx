...
const menuItems = [
  {
    items: [
      { icon: FaSchool, label: "Home", href: "/parent", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaUsers, label: "My Children", href: "/parent/mychildren", visible: ["parent"] },
      { icon: FaCreditCard, label: "Fee", href: "/parent/fee", visible: ["parent"] },
      { icon: FaBook, label: "Diary", href: "/parent/diary", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaClipboardList, label: "Exam Reports", href: "/parent/exams", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaUserCheck, label: "Attendance", href: "/parent/attendance", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaCalendarCheck, label: "Events", href: "/parent/events", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaComments, label: "Messages", href: "/parent/messages", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaBullhorn, label: "Announcements", href: "/parent/announcements", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaQuestionCircle, label: "Help", href: "/parent/help", visible: ["admin", "teacher", "student", "parent"] },
    ],
  },
];
