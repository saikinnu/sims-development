...
import { ShieldCheck, UserCheck, Mail, Link, AlertCircle, Info, Users, PhoneCall } from 'lucide-react'; // **FIXED: Added 'Users' and 'PhoneCall' to imports**

const PrivacyPolicy = () => {
    return (
        <div className="p-6 bg-gray-50 min-h-screen font-sans">
            {/* Hero Section */}
            <div className="relative bg-gradient-to-r from-teal-700 to-teal-900 text-white p-12 rounded-lg shadow-xl mb-8 overflow-hidden">
            ...
            <div className="bg-white rounded-lg shadow p-8 max-w-4xl mx-auto">
                <div className="text-sm text-gray-500 mb-6 text-center">
                    ...
                    Last updated: <span className="font-semibold text-gray-700">June 27, 2025</span>
                </div>
