...
import { Eye, Target, Feather, Users, PhoneCall } from 'lucide-react'; // Importing new icons

const AboutUs = () => {
    return (
        <div className="p-6 bg-gray-50 min-h-screen font-sans">
            {/* Hero Section */}
            <div className="relative bg-gradient-to-r from-blue-700 to-blue-900 text-white p-12 rounded-lg shadow-xl mb-8 overflow-hidden">
