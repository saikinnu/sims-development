...
import { FiDownload, FiFileText } from 'react-icons/fi'; // Action icon and generic file icon
import { FaFilePdf, FaRegImage, FaVideo, FaLink } from 'react-icons/fa'; // Resource type icons
  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-200 flex justify-center mt-auto">
        ...
        >
          <FiDownload className="mr-2" /> View Resource
        </button>
      </div>
    </div>
  );
