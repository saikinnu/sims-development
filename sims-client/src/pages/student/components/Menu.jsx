...
const menuItems = [
  {
    items: [
      { icon: FaSchool, label: "Home", href: "/student", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaJournalWhills, label: "Diary", href: "/student/diary", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaClipboardList, label: "Exam Reports", href: "/student/exams", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaRegCalendarAlt, label: "Schedules", href: "/student/schedules", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaClipboardCheck, label: "Assignments", href: "/student/assignments", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaDesktop, label: "Library", href: "/student/library", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaUserCheck, label: "Attendance", href: "/student/attendance", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaCalendarCheck, label: "Events", href: "/student/events", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaComments, label: "Messages", href: "/student/messages", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaBullhorn, label: "Announcements", href: "/student/announcements", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaQuestionCircle, label: "Help", href: "/student/help", visible: ["admin", "teacher", "student", "parent"] },
    ],
  },
];
