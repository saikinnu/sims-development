        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white border rounded-xl p-8 shadow-sm mb-8">
              ...
              {/* Bio */}
              <div className="mt-7">
                <label htmlFor="bio" className="block text-sm font-medium text-gray-700 mb-2">Bio / About Me</label>
                {isEditing ? (
                  <textarea
                    id="bio"
                    name="bio"
                    ...
                    rows="4"
                    className="w-full border border-gray-300 px-4 py-2.5 rounded-lg resize-y focus:ring-blue-500 focus:border-blue-500"
                  />
                ) : (
                  <p className="bg-gray-50 px-4 py-2.5 border border-gray-200 rounded-lg leading-relaxed whitespace-pre-line text-gray-800">
