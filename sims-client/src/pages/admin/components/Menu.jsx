...
import { FaSchool,FaChalkboardTeacher,FaUserGraduate,FaUsers,FaCreditCard,
  ...
  FaLaptopCode,FaTimes,FaBars} from "react-icons/fa";

// Define your menu items with absolute paths for better routing consistency
const menuItems = [
  {
    items: [
      { icon: FaSchool, label: "Home", href: "/admin", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaChalkboardTeacher, label: "Teachers", href: "/admin/teachers", visible: ["admin", "teacher"] },
      { icon: FaUserGraduate, label: "Students", href: "/admin/students", visible: ["admin", "teacher"] },
      { icon: FaUsers, label: "Parents", href: "/admin/parents", visible: ["admin", "teacher"] },
      { icon: FaCreditCard, label: "Fee", href: "/admin/fee", visible: ["admin"] },
      { icon: FaLandmark, label: "Bank", href: "/admin/bank", visible: ["admin"] },
      { icon: FaBook, label: "Subjects", href: "/admin/subjects", visible: ["admin"] },
      { icon: FaLaptopCode, label: "Classes", href: "/admin/classes", visible: ["admin", "teacher"] },
      { icon: FaClipboardList, label: "Exam Reports", href: "/admin/exams", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaRegCalendarAlt, label: "Schedules", href: "/admin/schedules", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaClipboardCheck, label: "Assignments", href: "/admin/assignments", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaDesktop, label: "Library", href: "/admin/library", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaChartBar, label: "Results", href: "/admin/results", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaUserCheck, label: "Attendance", href: "/admin/attendance", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaCalendarCheck, label: "Events", href: "/admin/events", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaComments, label: "Messages", href: "/admin/messages", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaBullhorn, label: "Announcements", href: "/admin/announcements", visible: ["admin", "teacher", "student", "parent"] },
      { icon: FaQuestionCircle, label: "Help", href: "/admin/help", visible: ["admin", "teacher", "student", "parent"] },
    ],
  },
];
