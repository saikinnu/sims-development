...
const AssignmentsTable = () => {
  // Sample data
  const assignments = [
    { id: 1, assignment: "Math Homework: Chapter 3 Exercises", class: "Algebra 101", dueDate: "2023-10-15", status: "Pending" },
    { id: 2, assignment: "Science Project: Ecosystems Research", class: "Biology 201", dueDate: "2023-10-20", status: "Completed" },
    { id: 3, assignment: "History Essay: French Revolution", class: "World History", dueDate: "2023-10-25", status: "Late" },
    { id: 4, assignment: "English Paper: Literary Analysis", class: "Literature 101", dueDate: "2023-10-18", status: "Completed" },
    { id: 5, assignment: "Physics Lab: Kinematics Experiment", class: "Physics 301", dueDate: "2023-10-22", status: "Pending" },
    { id: 6, assignment: "Chemistry Quiz: Periodic Table", class: "Chemistry 201", dueDate: "2023-10-30", status: "Pending" },
    { id: 7, assignment: "Art Portfolio: Still Life Drawing", class: "Art Fundamentals", dueDate: "2023-11-05", status: "Pending" },
    { id: 8, assignment: "Computer Science: Python Basics", class: "Intro to CS", dueDate: "2023-11-10", status: "Completed" },
  ];
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
      <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
        <BookOpen size={28} className="text-purple-600" /> Upcoming Assignments
      </h2>
              ...
              currentItems.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 flex items-center gap-2">
                    <Calendar size={16} className="text-gray-400" /> {item.dueDate}
                  </td>
