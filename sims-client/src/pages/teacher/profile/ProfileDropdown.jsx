...
import { LogOut, Settings, Info, Shield, User } from 'lucide-react'; // Import User icon for consistency
    ...
    <div className="absolute right-0 mt-2 w-64 bg-gray-800 rounded-md shadow-lg py-2 z-50 border border-gray-700 animate-fade-in-down">
      ...
      <div className="px-4 py-3 border-b border-gray-700 flex flex-col items-center">
        <img
          ...
          width={64}
          height={64}
          className="rounded-full mb-2 border-2 border-gray-600 object-cover"
        />
      ...
      <div className="py-1">
        <button
          ...
          onClick={() => handleClick(onSettingsClick)} // Call handleClick
        >
