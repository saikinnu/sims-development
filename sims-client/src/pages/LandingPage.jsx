...
// import SIMSIcon from '../assets/simsicon.jpg'; 
import SIMSLogo from '../assets/sims.png'; 
import AuthContainer from './AuthContainer'; // Import AuthContainer instead of LoginPage
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans antialiased text-gray-800 relative">
      {/* Floating Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-50 p-4 sm:p-6 md:p-8 flex justify-between items-center transition-all duration-300 ${isNavbarSolid ? 'backdrop-blur-md bg-white/80 shadow-lg' : 'bg-transparent'}`}>
        <div className="flex items-center space-x-2">
          {/* <GraduationCap className="text-indigo-600 h-8 w-8 animate-fade-in-down" /> */}
          <img src={SIMSLogo} alt="SIMS Logo" className="h-10 w-15 animate-fade-in-down" />
          {/* <img src={SIMSIcon} alt="SIMS Logo" className="h-20 w-20 animate-fade-in-down" /> */}
          {/* <span className="text-xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent animate-fade-in-down delay-100">
            SIMS
          </span> */}
        </div>
      </nav>
      ...
      >
        <div className="relative z-20 flex flex-col items-center max-w-4xl mx-auto">
          {/* <div className="p-6 backdrop-blur-sm bg-white/10 rounded-full mb-8 transform -rotate-3 hover:rotate-0 transition-transform duration-300 animate-fade-in-up"> */}
            {/* <GraduationCap size={80} className="text-white" /> */}
            <img src={SIMSLogo} alt="SIMS Logo" className="h-40 w-85 animate-fade-in-down" />
          {/* </div> */}

          <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight mb-6 tracking-tight bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent animate-fade-in-up delay-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-300">
            <a
              href="#" // Changed to # as we're handling with JS
              onClick={handleLoginClick} // Add onClick handler
              className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-bold text-lg shadow-xl hover:shadow-indigo-400/50 transition-all duration-300 hover:scale-105 flex items-center justify-center group"
            >
              Get Started <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
            </a>
            <a
              href="#features"
              className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300 flex items-center justify-center"
            >
              Explore Features
            </a>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6 animate-fade-in-up delay-400">
            <div className="backdrop-blur-sm bg-white/10 p-4 rounded-xl border border-white/20 transform hover:scale-105 transition-transform duration-200">
              <p className="text-3xl font-bold text-white">500+</p>
              <p className="text-gray-200">Institutes</p>
            </div>
            <div className="backdrop-blur-sm bg-white/10 p-4 rounded-xl border border-white/20 transform hover:scale-105 transition-transform duration-200">
        ...
        {/* Floating elements */}
        <div className="absolute top-1/4 left-10 w-16 h-16 rounded-full bg-purple-500/30 blur-xl animate-float-1"></div>
        <div className="absolute bottom-1/3 right-20 w-24 h-24 rounded-full bg-indigo-500/30 blur-xl animate-float-2"></div>
      </header>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative bg-white rounded-2xl p-8 border-2 border-indigo-500 shadow-xl transform scale-105 z-10 animate-fade-in-up delay-100">
              ...
              <div className="mb-8">
                <span className="text-5xl font-extrabold text-gray-900">₹8,000</span>
                <span className="text-gray-600">/month</span>
                <p className="text-sm text-gray-500 mt-1">Billed annually (₹96,000)</p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm relative animate-zoom-in"> {/* Max-width adjusted for login/auth forms */}
            <button
              onClick={closeLoginModal} // Use the dedicated close function
              className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 transition-colors"
            >
              <X size={24} />
            </button>
            <AuthContainer onClose={closeLoginModal} /> {/* Render AuthContainer here */}
          </div>
        </div>
      )}
